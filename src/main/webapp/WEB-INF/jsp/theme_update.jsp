                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <br/>
                                        <input type="text" name="theme" required value="${theme.theme}"
                                    ...
                                    <td>
                                        <br/>
                                        <input type="text" name="theme_en" required value="${theme.theme_en}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <br/>
                                        <input type="text" name="description_en" value="${theme.description_en}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <br/>
                                        <input type="text" name="time" value="${theme.time}"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <br/>
                                        <input type="text" name="passing_grade" required value="${theme.passing_grade}"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <input type="hidden" name="action" value="edit-theme">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
